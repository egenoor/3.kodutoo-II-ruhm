    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" >
                ...
                <input id="movie_actor" name="movie_actor" type="text" class="form-control" value="<?php echo $c->movie_actor;?>" ><br><br>
                <label for="movie_fav" >Favorite movie</label><br>
                <input id="movie_fav" name="movie_fav" type="text" class="form-control" value="<?php echo $c->movie_fav;?>" ><br><br>
